...
export const Special = () => {
  ...
  return (
    ...
    <section>
        ...
        <div className="">
                    <h2 className='text-[39px] text-[#292929] font-dm font-bold'>Special Offers</h2>
                </div>
                ...
                <div className=" pt-[48px]">
                    <Slider {...settings}>
                        ...
                        <div className="lg:!w-[90%] ">
                            <div className="">
                                <div className="relative group overflow-hidden">
                                    <img src={pic6} className='w-full lg:h-[270px]' alt="" />
                        ...
                        <div className="lg:!w-[90%]  ">
                            <div className="">
                                <div className="relative group overflow-hidden">
                                    <img src={pic7} className='w-full lg:h-[270px]' alt="" />
                        ...
                        <div className="lg:!w-[90%]  ">
                            <div className="">
                                <div className="relative group overflow-hidden">
                                    <img src={pic8} className='w-full lg:h-[270px]' alt="" />
                        ...
                        <div className="lg:!w-[90%]  ">
                            <div className="">
                                <div className="relative group overflow-hidden">
                                    <img src={pic9} className='w-full lg:h-[270px]' alt="" />
